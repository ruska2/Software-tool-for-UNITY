...
import QueryConverter from "../Converter/VerificationParser/QueryConverter";
...
class VerificationEditor extends Component {
            ...
            <div id ="verifholder" style={{backgroundColor: headC}}>
                <div id={"verificationLabel"} style={{ position: "relative", color: textC}}>
                    <strong>Verification</strong>
                        <button style={{float:"right", verticalAlign: "middle", horizontalAlign: "middle", width:"100px"}} id="toQueryb" onClick={this.onQueryConvert}> >>> .query</button>
    ...
    onChange = (newValue) => {
        this.props.onVerificationCodeChange(newValue);

    };

    onQueryConvert = () => {
        let text = "";
        let convert = new QueryConverter(this.state.code);
        text = this.state.code;
        this.props.onQueryChange(convert.convertToString());
    };
